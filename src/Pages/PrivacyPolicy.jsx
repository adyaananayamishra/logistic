...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <p className="mb-4">We may collect personal information from you, such as your name, email address, phone number, and shipping details when you create an account, make a shipment, or contact us for inquiries. This information is necessary for us to provide you with our services.</p>
      ...
      <p className="mb-4">We use secure systems and technologies to ensure that your personal information is protected from unauthorized access, use, or disclosure. We follow industry best practices to safeguard your data both online and offline.</p>
      
      <h2 className="text-xl font-semibold mt-6">4. Sharing of Information</h2>
      <p className="mb-4">We do not sell or share your personal information with third parties, except in cases where it is necessary to fulfill your shipping requests or comply with legal obligations. We may share your information with trusted partners for the purpose of processing shipments and ensuring timely deliveries.</p>
