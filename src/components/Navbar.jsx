...
//           <span className="text-gray-800 font-semibold pt-8">Adya Express</span>
//         </Link>
    ...
    <nav className="bg-white shadow-lg fixed w-full z-50">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center space-x-2">
          ...
          />
          <span className="text-gray-800 font-semibold text-xl">Adya Express</span>
        </Link>
      ...
      {/* Mobile Sidebar Menu */}
      <div
        className={`fixed top-0 right-0 h-full w-2/3 sm:w-1/2 bg-white shadow-lg transform ${menuOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out md:hidden z-50`}
      >
        <div className="flex justify-between items-center p-4 border-b">
          <h2 className="text-lg font-bold text-gray-800">Menu</h2>
          <button onClick={() => setMenuOpen(false)}>
