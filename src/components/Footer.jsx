...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white pt-12">
      <div className="container mx-auto px-10 grid grid-cols-1 md:grid-cols-4 gap-8 text-gray-300">
        ...
        <div className="text-center md:text-left">
          ...
          <a href="/about">
          <button className="mt-4 px-5 py-2 home contact us bg-blue-600 text-white rounded-md transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
            About Us
          </button>
          </a>
        </div>
        ...
        <div>
          ...
          <p className="text-sm">Sundargarh,Rourkela pincode-770001</p>
      ...
      <p>Copyright © 2024  <strong className="text-white"> Developed By First Track Solution Technologies</strong></p>
    ...
    <Link to="/terms-of-use" className="hover:underline text-gray-400">Terms</Link>
  </p>
</div>
